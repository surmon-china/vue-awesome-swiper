...
[Swiper](https://swiperjs.com/) has released a mature and available [Vue component](https://swiperjs.com/vue), so the vue-awesome-swiper project will be discontinued and please gradually migrate to the official Vue plugin provided by Swiper.
